  ...
  return (
    <main className="min-h-screen bg-[color:var(--paper)] pt-28 pb-24 px-6 md:px-12">
      <div className="max-w-[800px] mx-auto">
        <div className="eyebrow mb-3">{t("legal.privacy.eyebrow")}</div>
        <h1 className="font-serif-display text-4xl md:text-5xl tracking-tight mb-4">{t("legal.privacy.title")}</h1>
